...
SECRET_KEY = 'django-insecure-fgo#$$r$m&r72^w$@h*xlv6u^2_3wokfowk#2p8@orx5h*j*sp'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'blog_app',         # Database name
        'USER': 'root',         # Database username
        'PASSWORD': 'badal@123', # Database password   
        'HOST': '127.0.0.1',                  # Database host (use '127.0.0.1' or IP for remote)
...
MEDIA_ROOT = 'C:/Users/badal/OneDrive/Desktop/files_of_django'
